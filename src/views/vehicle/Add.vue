                ...
                <Panel>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <Calendar id="registrationDate" v-model="vehicleData.registrationDate" dateFormat="dd/mm/yy" placeholder="Chọn ngày đăng ký" :showIcon="true" :class="{ 'p-invalid': submitted && validationErrors.registrationDate }" />
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <Calendar id="registrationExpiryDate" v-model="vehicleData.registrationExpiryDate" dateFormat="dd/mm/yy" placeholder="Chọn ngày hết hạn" :showIcon="true" />
                        </div>
                    </div>
                ...
                <Panel>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <Calendar id="insuranceExpiryDate" v-model="vehicleData.insuranceExpiryDate" dateFormat="dd/mm/yy" placeholder="Chọn ngày hết hạn" :showIcon="true" />
                        </div>
                    </div>
                </Panel>
