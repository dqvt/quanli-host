            ...
            <Panel>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex flex-col gap-2">
                        ...
                        <Calendar id="registrationDate" v-model="vehicleData.registrationDate" dateFormat="dd/mm/yy" />
                    </div>

                    <div class="flex flex-col gap-2">
                        <label for="registrationExpiryDate">Ngày hết hạn đăng ký</label>
                        <Calendar id="registrationExpiryDate" v-model="vehicleData.registrationExpiryDate" dateFormat="dd/mm/yy" />
                    </div>

                    <div class="flex flex-col gap-2">
                        <label for="insuranceExpiryDate">Ngày hết hạn bảo hiểm</label>
                        <Calendar id="insuranceExpiryDate" v-model="vehicleData.insuranceExpiryDate" dateFormat="dd/mm/yy" />
                    </div>
