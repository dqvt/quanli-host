    ...
    <Dialog v-model:visible="showExpenseDialog" :style="{ width: '450px' }" header="Thêm chi phí" :modal="true" :closable="!savingTransaction">
        <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-2">
                ...
                <Calendar id="date" v-model="newTransaction.date" :showIcon="true" dateFormat="dd/mm/yy" placeholder="Chọn ngày" :class="{ 'p-invalid': submitted && validationErrors.date }" />
    ...
    <Dialog v-model:visible="showCreditDialog" :style="{ width: '450px' }" header="Cập nhật tiền tạm ứng" :modal="true" :closable="!savingTransaction">
        <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-2">
                ...
                <Calendar id="creditDate" v-model="newTransaction.date" :showIcon="true" dateFormat="dd/mm/yy" placeholder="Chọn ngày" :class="{ 'p-invalid': submitted && validationErrors.date }" />
                <small v-if="submitted && validationErrors.date" class="p-error">
                    {{ validationErrors.date }}
                </small>
            </div>
    ...
    <Dialog v-model:visible="showEditBalanceDialog" :style="{ width: '450px' }" header="Chỉnh sửa số dư trực tiếp" :modal="true" :closable="!savingTransaction">
        <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-2">
                ...
                <Calendar id="editDate" v-model="editBalanceData.date" :showIcon="true" dateFormat="dd/mm/yy" placeholder="Chọn ngày" :class="{ 'p-invalid': submitted && validationErrors.editDate }" />
